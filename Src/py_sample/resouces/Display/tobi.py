...
image_title = pygame.image.load("img/title.png")
image_start = pygame.image.load("img/start.png")
image_final_bonus = pygame.image.load("img/final_bonus.png")
image_gameover = pygame.image.load("img/gameover.png")
image_shadow = pygame.image.load("img/shadow.gif")

#効果音
sound_frog_jump = pygame.mixer.Sound("snd/tobi/frog_jump.wav")
sound_frog_jump.set_volume(0.2)
sound_bird_fly = pygame.mixer.Sound("snd/tobi/bird_fly.wav")
sound_bird_fly.set_volume(0.25)
sound_jump = pygame.mixer.Sound("snd/tobi/jump.wav")
sound_jump.set_volume(0.25)
sound_eat = pygame.mixer.Sound("snd/tobi/eat.wav")
sound_eat.set_volume(0.3)
sound_omusubi = pygame.mixer.Sound("snd/tobi/omusubi.wav")
sound_omusubi.set_volume(0.6)
sound_crash = pygame.mixer.Sound("snd/tobi/crash.wav")
sound_crash.set_volume(0.4)
sound_miss = pygame.mixer.Sound("snd/tobi/miss.wav")
sound_miss.set_volume(0.6)
sound_finish = pygame.mixer.Sound("snd/tobi/finish.wav")
sound_finish.set_volume(0.6)

#BGM
pygame.mixer.music.load("snd/tobi/bgm.wav")
...
class Character:
    ...
    def __init__(self):
        ...
        self.width = 0
        self.height = 0
        self.image_man = pygame.image.load("img/man.gif")
        self.image_man_bright = pygame.image.load("img/man_bright.gif")
        self.image_man_failed = pygame.image.load("img/man_failed.gif")
        self.image_man_smile = pygame.image.load("img/man_smile.gif")
        self.image_tree = pygame.image.load("img/tree.gif")
        self.image_stopper = pygame.image.load("img/stopper.gif")
        self.image_frog = pygame.image.load("img/frog.gif")
        self.image_frog_jump1 = pygame.image.load("img/frog_jump1.gif")
        self.image_frog_jump2 = pygame.image.load("img/frog_jump2.gif")
        self.image_bird_right = pygame.image.load("img/bird_right.gif")
        self.image_bird_left = pygame.image.load("img/bird_left.gif")
        self.image_omusubi = pygame.image.load("img/omusubi.gif")
        self.image_house = pygame.image.load("img/house.gif")
